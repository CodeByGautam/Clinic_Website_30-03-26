...
export const metadata = {
  ...
  alternates: {
    canonical: "/ayurveda/panchakarma/basti"
  }
};
...
export default function BastiPage() {
  ...
  return (
    ...
    {/* Additional Basti Types Section */}
    
    {/* Niruha Basti Section */}
    <section className="py-10">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Niruha Basti, also known as decoction enema, is a cleansing Ayurvedic therapy that uses herbal decoctions to detoxify body and balance doshas.
        </p>
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>Detoxifies body and colon</li>
          <li>Balances Vata dosha</li>
          <li>Improves digestion and metabolism</li>
          <li>Useful in chronic disorders</li>
        </ul>
      </div>
    </section>
    ...
    <section className="py-10">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Matra Basti is a gentle oil-based enema therapy that nourishes and lubricates body without strong cleansing effects.
        </p>
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>Safe for daily use</li>
          <li>Strengthens body tissues</li>
          <li>Improves bowel movement</li>
          <li>Reduces dryness and fatigue</li>
        </ul>
      </div>
    </section>
    ...
    <section className="py-10">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Anuvasana Basti is an oil-based Ayurvedic therapy that provides deep nourishment and is mainly used to pacify aggravated Vata dosha.
        </p>
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>Nourishes body tissues</li>
          <li>Relieves joint pain</li>
          <li>Improves strength and vitality</li>
    ...
    <section className="py-10">
      <div className="max-w-5xl mx-auto px-4 text-center">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6">
          Need personalized Ayurvedic treatment?
        </h2>
